...
export declare const RadarChart: {
    new (props: import("./generateCategoricalChart").CategoricalChartProps): {
        ...
        getXScales(): {
            [x: string]: Function | "time" | "linear" | "auto" | "pow" | "sqrt" | "log" | "identity" | "band" | "point" | "ordinal" | "quantile" | "quantize" | "utc" | "sequential" | "threshold";
        };
        getYScales(): {
            [x: string]: Function | "time" | "linear" | "auto" | "pow" | "sqrt" | "log" | "identity" | "band" | "point" | "ordinal" | "quantile" | "quantize" | "utc" | "sequential" | "threshold";
        };
        getXScaleByAxisId(axisId: string): Function | "time" | "linear" | "auto" | "pow" | "sqrt" | "log" | "identity" | "band" | "point" | "ordinal" | "quantile" | "quantize" | "utc" | "sequential" | "threshold";
        getYScaleByAxisId(axisId: string): Function | "time" | "linear" | "auto" | "pow" | "sqrt" | "log" | "identity" | "band" | "point" | "ordinal" | "quantile" | "quantize" | "utc" | "sequential" | "threshold";
        getItemByXY(chartXY: {
            x: number;
            y: number;
        }): {
